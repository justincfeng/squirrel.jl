...
#-----------------------------------------------------------------------
"""
    gks( X::RealVec , p=[tpfl(738), tpfl(1)] , tpfl::DataType=Float64 )
...
"""
function gks( X::RealVec , p=[tpfl(738), tpfl(1)] , 
